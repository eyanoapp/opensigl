...
/* IMCK */
CREATE TEMPORARY TABLE temp_imck_role_unit AS (SELECT * FROM imck.role_unit);
DELETE FROM imck.role_unit;
DELETE FROM imck.unit;
INSERT INTO imck.unit VALUES
...
INSERT INTO imck.role_unit SELECT * FROM temp_imck_role_unit WHERE unit_id IN (SELECT id FROM imck.unit);

UPDATE imck.role_unit SET unit_id = 210 WHERE unit_id = 213;
UPDATE imck.role_unit SET unit_id = 216 WHERE unit_id = 215;
UPDATE imck.role_unit SET unit_id = 215 WHERE unit_id = 214;
UPDATE imck.role_unit SET unit_id = 213 WHERE unit_id = 212;
UPDATE imck.role_unit SET unit_id = 214 WHERE unit_id = 226;
UPDATE imck.role_unit SET unit_id = 226 WHERE unit_id = 225;
UPDATE imck.role_unit SET unit_id = 225 WHERE unit_id = 224;
UPDATE imck.role_unit SET unit_id = 240 WHERE unit_id = 243;
UPDATE imck.role_unit SET unit_id = 243 WHERE unit_id = 242;
UPDATE imck.role_unit SET unit_id = 242 WHERE unit_id = 241;
UPDATE imck.role_unit SET unit_id = 241 WHERE unit_id = 240;

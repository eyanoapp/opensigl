...
# run the tests
SUITE_NAME="OpenSIGL Stock Integration Tests" MOCHA_OUTPUT="results/integration-stock-report.xml" ./node_modules/.bin/mocha test/integration-stock --timeout 20000 \

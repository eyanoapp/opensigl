...
function LotsRegistryService(uiGridConstants, Session) {
  ...
  service.gridFooterTemplate = `
    <div class="ui-grid-cell-contents">
      ...
      <span class="bi bi-circle icon-expired legend" style="margin-left: 1em;"></span>
      <strong>
        <span translate>STOCK.EXPIRED</span>: {{grid.appScope.totals.expired}}
      </strong>

      <span class="bi bi-circle icon-at-risk-of-expiring legend" style="margin-left: 1em;"></span>
      <strong>
        <span translate>STOCK.RISK_OF_EXPIRATION</span>: {{grid.appScope.totals['at-risk-of-expiring']}}
      </strong>

      <span class="bi bi-circle icon-at-risk-of-stock-out legend" style="margin-left: 1em;"></span>
      <strong>
        <span translate>STOCK.RISK_OF_STOCK_OUT</span>: {{grid.appScope.totals['at-risk-of-stock-out']}}
      </strong>

      <span class="bi bi-circle icon-out-of-stock legend" style="margin-left: 1em;"></span>
      <strong>

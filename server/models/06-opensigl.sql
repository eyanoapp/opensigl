...
INSERT INTO unit (`id`, `name`, `key`, `description`, `parent`, `path`) VALUES
  ...
  (236,'Humans Ressources dashboard','TREE.DASHBOARDS.HUMANS_RESSOURCES','Tableau de bord du Personnel',233,'/dashboards/staff'),
...
INSERT IGNORE INTO `transaction_type` (`text`, `type`, `fixed`) VALUES
  ...
  ('VOUCHERS.SIMPLE.OPERATING_SUBSIDY', 'income', '1');
